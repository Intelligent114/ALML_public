...
如对题意、提交格式或数学符号有疑问，请先搜索并通过课程仓库的 GitHub Issues 提问：
\begin{center}
    \url{https://github.com/Intelligent114/ALML_public/issues/new/choose}
\end{center}
提问时注明 HW0 和具体题号；不要在公开 Issue 中发布本人学号、个人邮箱或完整作业答案。
...
\section{向量与矩阵\texorpdfstring{\points{20}}{（20 分）}}
...
\section{特征值与二次型\texorpdfstring{\points{15}}{（15 分）}}
...
\section{多元微积分与链式法则\texorpdfstring{\points{25}}{（25 分）}}
...
\section{概率与统计\texorpdfstring{\points{25}}{（25 分）}}
...
\section{梯度下降\texorpdfstring{\points{15}}{（15 分）}}
